...
You will also need to create a Particle account. Don't worry, it's is completely free to [signup](https://build.particle.io/signup). Once you have signed up, make sure to write down your username and password because we will need it soon. 

###TENTATIVE
You have two options for how we will setup webhooks in the future. You can use a command line tool or a sample console project to setup the webhook.

###

Next we need to install the Particle command line tools. 
